...
Make sure you have [Node](https://nodejs.org/en/) version 14 or greater. Depending on your operating system, you may also need to install python or other tools used by dependencies that need to be compiled.
