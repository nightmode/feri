...
```js
config.includeFileTypes = ['ejs', 'sass', 'scss', 'styl']
```
...
In the object below, a CSS file could be generated by a SASS, SCSS, or STYL file. This is incredibly valuable information that Feri uses to clean and build.
